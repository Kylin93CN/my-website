...
(function ($) {
    ...
    */
    ...
    $.bg_urls = ["https://media.lvxiang.site/img/sample6.jpg", "https://media.lvxiang.site/img/sample5.jpg"];
    ...
    $.wordrotator_words = ['<h4>好好学习</h4>', '<h4>天天向上</h4>']; //-- Array of words, for headline text
